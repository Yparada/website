...
export class InitialBoxComponent implements OnInit {
  ...
  My personal interests are lang programming as Java (Spring boot), TypeScript (Angular), Nodejs, Git, Github, Github Actions, Cloud computing and others related tools`;
